...
// EnvelopeTransformer is a messagepipeline.MessageTransformer function.
// It safely decodes a raw message payload into a transport.SecureEnvelope struct.
func EnvelopeTransformer(ctx context.Context, msg *messagepipeline.Message) (*transport.SecureEnvelope, bool, error) {
	...
	if err != nil {
		...
		// and signal that the message should be skipped and not retried.
